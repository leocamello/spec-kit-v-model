...
| **Software Architecture Design** (combined) | `software-architecture-design.md` | **IEEE 1016:2009** (design entity model §4.1, decomposition §5.1, dependencies §5.2, interfaces §5.3, data design §5.4) synthesized within **IEEE 42010:2011** (4 viewpoints) / Kruchten 4+1 / **ISO/IEC 42030:2019** (architecture evaluation) / **ISO/IEC 25010:2023** (quality attribute justification) / ASPICE SWE.2 (software architectural design process, only when `domain: iso_26262`) | ISO 26262-6 §7 (Software Architectural Design), ISO 26262-9 §5 (ASIL Decomposition); DO-178C §5.2.2 (Software Architecture); IEC 62304 §5.3 (Software Architecture) |
