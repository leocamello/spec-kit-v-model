...
| Value | Standard | System Design Extras | System Test Extras | Architecture Design Extras | Software Architecture Design Extras | Integration Test Extras | Module Design Extras | Unit Test Extras |
|-------|----------|---------------------|--------------------|---------------------------|-------------------------------------|------------------------|---------------------|-----------------|
| `""` (empty) | None | — | — | — | — | — | — | — |
| `iso_26262` | ISO 26262 (Automotive) | FFI analysis, Restricted Complexity | MC/DC targets, WCET verification | ASIL Decomposition, Defensive Programming | ASPICE SWE.2 BP1–BP9 process guidance, ASIL Decomposition, Defensive Programming | SIL/HIL Compatibility, Resource Contention | Complexity Limits (≤10), Memory Management, MISRA/CERT-C | MC/DC Coverage, Variable-Level Fault Injection |
| `do_178c` | DO-178C (Aerospace) | FFI analysis, Restricted Complexity | MC/DC targets, WCET verification | ASIL Decomposition, Temporal Constraints | ASPICE SWE.2 BP1–BP9 process guidance, Temporal Constraints | SIL/HIL Compatibility, Resource Contention | Single Entry/Exit, Memory Management, Complexity Limits | MC/DC Coverage, Variable-Level Fault Injection |
| `iec_62304` | IEC 62304 (Medical Devices) | FFI analysis, Restricted Complexity | MC/DC targets, WCET verification | ASIL Decomposition, Defensive Programming | ASPICE SWE.2 BP1–BP9 process guidance, Safety Class allocation | SIL/HIL Compatibility, Resource Contention | Complexity Limits (≤10), Memory Management | MC/DC Coverage, Variable-Level Fault Injection |
...
- `/speckit.v-model.software-architecture-design`: Adds **ASPICE SWE.2** process guidance (BP1–BP9) and **ISO 26262-6 §7** software architectural design sections — an alternative combined path that reads `requirements.md` directly
