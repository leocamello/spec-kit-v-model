...
- The `validate-system-coverage.sh` script uses regex-based parsing (consistent with `validate-coverage.sh` from v0.1.0) — it does not require a runtime database or external tooling.
