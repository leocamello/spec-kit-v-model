...
| REQ-NF-005 | The `/speckit.v-model.system-design` and `/speckit.v-model.system-test` commands SHALL produce outputs that meet or exceed the LLM-as-judge evaluation thresholds established for v0.1.0 acceptance-level artifacts (GEval requirements quality ≥ 0.7, BDD quality ≥ 0.7, structural compliance ≥ 0.95). | P1 | SC-007: Semantic quality of AI-generated artifacts must be validated by automated evaluation to prevent prompt regression. | Test |
