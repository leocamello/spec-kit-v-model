...
- **Missing optional V-Model artifacts** (e.g., no `hazard-analysis.md`, no `system-test.md`): all three bridge commands MUST proceed with reduced enrichment and report what was missing in their summary output.
