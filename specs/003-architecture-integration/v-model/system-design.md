...
- **SYS-001, SYS-004**: Suspect from REQ-021 (deprecated → REQ-050). Resolved: confirmed active — REQ-021 retained as legacy parent; REQ-050 added as superseding parent.
- **SYS-002, SYS-005**: Suspect from REQ-022 (deprecated → REQ-051). Resolved: confirmed active — REQ-022 retained as legacy parent; REQ-051 added as superseding parent.
...
| Total Parent Requirements Covered | 65 / 68 (95.6%) (3 deprecated REQs — REQ-047, REQ-048, REQ-CN-001 — excluded from SYS parents per lifecycle rules) |
