...
#
# BATS suite for the setup-implement.sh bridge wrapper. Forwards to upstream
# .specify/scripts/bash/check-prerequisites.sh and augments with VMODEL_DIR.

load "test_helper"

WRAPPER="${SCRIPTS_DIR}/setup-implement.sh"
...
#!/usr/bin/env bash
echo '{"FEATURE_DIR":"$FEATURE_DIR","AVAILABLE_DOCS":["tasks.md"]}'
exit $rc
EOF
